...
(function make_xlsx(XLSX) {
        ...
        switch ((c = fmt.charAt(i))) {
          ...
          case '#':
            ...
            while (
              ...
              (c == '\\' && fmt.charAt(i + 1) == '-' && i < fmt.length - 2 && '0#'.indexOf(fmt.charAt(i + 2)) > -1)
            )
              o += c;
  ...
  var crypto_CreateXorArray_Method1 = (function () {
    ...
    var InitialCode = [
      57840, 7439, 52380, 33984, 4364, 3600, 61902, 12606, 6258, 57657, 54287, 34041, 10252, 43370, 20163,
    ];
    var XorMatrix = [
  ...
  function write_FONTS_bin(ba, data) {
    ...
    write_record(
      ba,
      'BrtFont',
      write_BrtFont({ sz: 12, color: { theme: 1 }, name: 'Calibri', family: 2, scheme: 'minor' }),
    );
  ...
  function write_CELLSTYLEXFS_bin(ba, data) {
    ...
    write_record(ba, 'BrtXF', write_BrtXF({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535));
  ...
  function write_STYLES_bin(ba, data) {
    ...
    write_record(ba, 'BrtStyle', write_BrtStyle({ xfId: 0, builtinId: 0, name: 'Normal' }));
      ...
      .forEach(function (c, i) {
        o = o.concat([
          '<v:shape' +
            ...
            '>',
          writextag('v:fill', writextag('o:fill', null, { type: 'gradientUnscaled', 'v:ext': 'view' }), {
            color2: '#BEFF82',
            angle: '-180',
            type: 'gradient',
          }),
