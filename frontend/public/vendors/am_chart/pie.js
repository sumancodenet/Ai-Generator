  ...
  k.AmSlicedChart = k.Class({
    ...
    clickSlice: function (a, b, c) {
      this.checkTouchDuration(b) &&
        ...
        c || this.fire({ type: 'clickSlice', dataItem: a, chart: this, event: b }));
    },
    ...
    pullSlice: function (a, b, c) {
      ...
      if ((c = a.wedge))
        0 < d
          ? (c.animate({ translate: b * a.pullX + ',' + b * a.pullY }, d, this.pullOutEffect),
            a.labelSet && a.labelSet.animate({ translate: b * a.pullX + ',' + b * a.pullY }, d, this.pullOutEffect))
          : (a.labelSet && a.labelSet.translate(b * a.pullX, b * a.pullY), c.translate(b * a.pullX, b * a.pullY));
      1 == b
        ? ((a.pulled = !0),
          ...
          for (var E, h = 0; h < a.length; h++)
            if (((e = a[h]), !0 !== e.hidden && (this.showZeroSlices || 0 !== e.percents))) {
              ...
              if (this.labelsEnabled && this.labelText && e.percents >= this.hideLabelsPercent) {
                  ...
                  90 >= l && 0 <= l
                    ...
                    : 90 <= l && 180 > l
                      ...
                      : 180 <= l && 270 > l
                        ...
                        : 270 <= l && 354 >= l
                          ? ((y = 3), (x = 'end'), (v = -8))
                          : 354 <= l && (h > E ? ((y = 0), (x = 'start'), (v = 8)) : ((y = 3), (x = 'end'), (v = -8)));
                  e.labelQuarter = y;
                } else x = 'middle';
                ...
                t || (t = this.color);
                '' !== l &&
                  ((l = k.wrappedText(c, l, t, this.fontFamily, this.fontSize, x, !1, this.maxLabelWidth)),
              ...
              this.accessible &&
                ...
                ((D = this.formatString(this.accessibleLabel, e)), this.makeAccessible(p, D));
    ...
    checkOverlapping: function (a, b, c, d, g) {
      ...
      if (n) {
        ...
        !0 === f &&
          200 > g &&
          isNaN(b.labelRadius) &&
          ((f = b.ty + 3 * b.iy), (b.ty = f), n.translate(b.textX, f), this.checkOverlapping(a, b, c, d, g + 1));
      }
    },
