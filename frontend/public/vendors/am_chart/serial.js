...
(function () {
  ...
  e.AmSerialChart = e.Class({
    ...
    onDataUpdated: function () {
      ...
      0 < b.length &&
        ((this.firstTime = this.getStartTime(b[0].time)), (this.lastTime = this.getEndTime(b[b.length - 1].time)));
      this.drawChart();
    ...
    showZB: function () {
      ...
      b &&
        b.parseDates &&
        !b.equalSpacing &&
        (this.startTime > this.firstTime && (a = !0), this.endTime < this.lastTime && (a = !0));
      0 < this.start && (a = !0);
      this.end < this.chartData.length - 1 && (a = !0);
      if ((b = this.valueAxes))
        (b = b[0]),
          isNaN(b.relativeStart) ||
            (0 !== e.roundTo(b.relativeStart, 3) && (a = !0), 1 != e.roundTo(b.relativeEnd, 3) && (a = !0));
    ...
    formatPeriodString: function (a, b) {
      if (b) {
        ...
        for (var l = 0; l < c.length; l++) {
          for (
            var k = c[l], m = 0, p = 0, n = 0, u = 0, v, x, E, t, r, B, q, w, y, C, F = this.start;
            F <= this.end;
            F++
          ) {
            var D = h[F];
    ...
    processScrollbars: function () {
      ...
      a &&
        ((a = e.processObject(a, e.ChartScrollbar, this.theme)), (a.id = 'valueScrollbar'), this.addValueScrollbar(a));
    },
    ...
    draw: function () {
      ...
      if (0 < Math.abs(h) || 0 < Math.abs(f))
        if (isNaN(t))
          ...
          0.1 < I &&
            0.1 < I &&
            ((z = e.circle(b, I, e.adjustLuminosity(B, 0.5), k, m, p, n, !1, J)), z.translate(O, P));
        }
      k = Q;
      1 > Math.abs(g) && (g = 0);
      1 > Math.abs(d) && (d = 0);
          ...
          if ((t = this.data[b]))
            this.parseDates && !this.equalSpacing
              ? ((m = t.time),
                (d = this.cellWidth),
                'MM' == this.minPeriod &&
                  ((d = 864e5 * e.daysInMonth(new Date(m)) * this.stepWidth), (t.cellWidth = d)),
