        ...
        d = {
          ...
          libs: {
            ...
            resources: [
              ...
              { 'jszip/jszip.min.js': ['xlsx/xlsx.min.js'], 'pdfmake/pdfmake.min.js': ['pdfmake/vfs_fonts.js'] },
            ],
            namespaces: {
          ...
          drawing: {
            ...
            handler: {
              undo: function () {
                ...
                if (c) {
                  if (((c.selectable = !0), d.drawing.redos.push(c), 'added' == c.action))
                      ...
                      c.target instanceof fabric.Group
                        ? ((u = d.prepareGroupState(u)),
                          ...
                          d.drawing.handler.change(
                            { color: u.cfg.color, width: u.cfg.width, opacity: u.cfg.opacity },
                            !0,
                            c.target,
                          ))
                        : c.target.set(u);
              ...
              redo: function () {
                ...
                (d.drawing.enabled = !1),
                  ...
                  d.isElement(d.setup.wrapper) &&
                    ...
                    (d.setup.wrapper.parentNode.removeChild(d.setup.wrapper), (d.setup.wrapper = !1));
              },
              add: function (c) {
                ...
                f(u.url, function (h, m) {
                  var w = void 0 === m ? h : fabric.util.groupSVGElements(h, m),
                    N = !1;
                  (w.height > d.setup.fabric.height || w.width > d.setup.fabric.width) &&
                    (N = d.setup.fabric.height / 2 / w.height),
                    u.top > d.setup.fabric.height && (u.top = d.setup.fabric.height / 2),
                    u.left > d.setup.fabric.width && (u.left = d.setup.fabric.width / 2),
              ...
              change: function (c, u, f) {
                ...
                if (
                  ...
                  h.width &&
                    ...
                    1 == d.drawing.width && (d.drawing.fontSize = h.fontSize = d.defaults.fabric.drawing.fontSize)),
                  ...
                  for (
                    ...
                    T[w] instanceof fabric.Text || T[w] instanceof fabric.PathGroup || T[w] instanceof fabric.Triangle
                      ? ((h.color || h.opacity) && T[w].set({ fill: h.color }),
                        h.fontSize && T[w].set({ fontSize: h.fontSize }))
                      : (T[w] instanceof fabric.Path || T[w] instanceof fabric.Line) &&
                        (S instanceof fabric.Group
                          ? (h.color || h.opacity) && T[w].set({ stroke: h.color })
                          : ((h.color || h.opacity) && T[w].set({ stroke: h.color }),
                            h.width && T[w].set({ strokeWidth: h.width })));
                  u ||
                    ((m = JSON.stringify(
                      d.deepMerge(d.getState(S), { cfg: { color: h.color, width: h.width, opacity: h.opacity } }),
                    )),
                    (S.recentState = m),
                    (d.drawing.redos = []),
                    d.drawing.undos.push({ action: 'modified', target: S, state: m })),
                    d.setup.fabric.renderAll();
                }
              },
              text: function (c) {
              ...
              line: function (c) {
                ...
                if (
                  (u.group.push(N),
                  u.arrow &&
                    ((u.angle = u.angle ? u.angle : d.getAngle(u.x1, u.y1, u.x2, u.y2)),
                    'start' == u.arrow
                      ? ((m = u.y1 + u.width / 2), (w = u.x1 + u.width / 2))
                      : 'middle' == u.arrow
                        ? ((m = u.y2 + u.width / 2 - (u.y2 - u.y1) / 2), (w = u.x2 + u.width / 2 - (u.x2 - u.x1) / 2))
                  ...
                  if (u.arrow) {
                    ...
                    return (
                      S.set({ cfg: u, fill: u.color, action: u.action, selectable: !0, known: 'change' == u.action }),
                ...
                d.createMenu([
                  {
                    ...
                    click: function () {
                      d.createMenu(d.config.menu),
                        d.isElement(d.setup.chart.containerDiv) && d.setup.chart.containerDiv.removeChild(m);
                    },
                  },
                ]);
              ...
              ? (Object.keys(u).some(function (N) {
                  return 'array' == w && isNaN(N)
                    ...
                    : void ((m = u[N]),
                      ...
                      !(m instanceof Function || m instanceof Date || d.isElement(m)) &&
                      'chart' != N &&
                      'scope' != N
                        ? d.deepMerge(c[N], m, f)
          ...
          isPressed: function (c) {
            return (
              ('mousemove' == c.type && 1 === c.which) ||
                ('touchmove' == c.type || 1 === c.buttons || 1 === c.button || 1 === c.which
          ...
          isSupported: function () {
            return (
              ...
              (d.setup.isIE &&
              9 >= d.setup.IEversion &&
              (!Array.prototype.indexOf || !document.head || !1 === d.config.fallback)
                ? !1
                : !0)
            );
          },
          ...
          gatherClassName: function (c, u, f, h) {
            var m,
              ...
              f = f ? f : 3;
            if (d.isElement(c)) {
              if (((m = -1 != (c.getAttribute('class') || '').split(' ').indexOf(u)), !m && h < f))
          ...
          gatherElements: function (c, u, f) {
            ...
            for (h = 0; h < c.children.length; h++) {
              ...
              if ('clipPath' == w.tagName) {
                ...
                f.included++,
                  fabric.Image.fromURL(w.getAttribute('xlink:href'), function () {
                    f.loaded++;
                  });
              else {
                var A = ['fill', 'stroke'];
          ...
          gatherPosition: function (c, u) {
            ...
            return (
              'touchmove' == c.type &&
                ('touches' in c ? (c = c.touches[0]) : 'changedTouches' in c && (c = c.changedTouches[0])),
              (m = fabric.util.transformPoint(d.setup.fabric.getPointer(c, !0), h)),
            ...
            (fabric.ElementsParser.prototype.resolveGradient = function (c, u) {
              ...
              if (/^url\(/.test(f)) {
                ...
                if (fabric.gradientDefs[this.svgUid][h]) {
                  ...
                  m.coords.y1 && 'pie' != d.setup.chart.type && ((m.coords.y2 = -1 * m.coords.y1), (m.coords.y1 = 0)),
                    c.set(u, m);
                }
              }
            }),
              (fabric.Text.fromElement = function (c, u) {
                ...
                (u = fabric.util.object.extend(u ? fabric.util.object.clone(u) : {}, f)),
                  (u.top = u.top || 0),
                  (u.left = u.left || 0),
                  'dx' in f && (u.left += f.dx),
                  'dy' in f && (u.top += f.dy),
                  'fontSize' in u || (u.fontSize = fabric.Text.DEFAULT_SVG_FONT_SIZE),
          ...
          capture: function (c, u) {
            ...
            for (f = 0; f < T.length; f++) {
              ...
              (A.has.legend = d.gatherClassName(A.parent, d.setup.chart.classNamePrefix + '-legend-div', 1)),
                (A.has.panel = d.gatherClassName(A.parent, d.setup.chart.classNamePrefix + '-stock-panel-div')),
                (A.has.scrollbar = d.gatherClassName(A.parent, d.setup.chart.classNamePrefix + '-scrollbar-chart-div')),
            ...
            if (d.config.legend) {
              ...
              for (f = 0; f < S.items.length; f++) {
                ...
                (S.width += A.legend.width),
                  ...
                  (S.maxWidth = A.legend.width > S.maxWidth ? A.legend.width : S.maxWidth),
                  (S.maxHeight = A.legend.height > S.maxHeight ? A.legend.height : S.maxHeight),
                  (A = d.gatherElements(A, h, N)),
                  m[A.legend.type](A);
              }
              -1 == ['top', 'bottom'].indexOf(d.config.legend.position)
                ? -1 == ['left', 'right'].indexOf(d.config.legend.position)
                  ...
                  : ((w.width += S.maxWidth), (w.height = S.height > w.height ? S.height : w.height))
                : ((w.width = S.maxWidth > w.width ? S.maxWidth : w.width), (w.height += S.height));
            }
            if (
              ...
              d.setup.chart.leftContainer &&
                ...
                (F.left = d.setup.chart.leftContainer.offsetWidth + 2 * d.setup.chart.panelsSettings.panelSpacing)),
                d.setup.chart.rightContainer &&
                  ((w.width -= d.setup.chart.rightContainer.offsetWidth),
                  (F.right = d.setup.chart.rightContainer.offsetWidth + 2 * d.setup.chart.panelsSettings.panelSpacing)),
                d.setup.chart.periodSelector &&
                  -1 != ['top', 'bottom'].indexOf(d.setup.chart.periodSelector.position) &&
                  ((w.height -= d.setup.chart.periodSelector.offsetHeight + d.setup.chart.panelsSettings.panelSpacing),
                  (F[d.setup.chart.periodSelector.position] +=
                    d.setup.chart.periodSelector.offsetHeight + d.setup.chart.panelsSettings.panelSpacing)),
            ...
            var D = d.removeFunctionsFromObject(
              d.deepMerge({ width: w.width, height: w.height, isDrawingMode: !0 }, h),
            );
            for (
              d.setup.fabric = new fabric.Canvas(d.setup.canvas, D),
                      ...
                      (P = G.group[f]),
                        P instanceof fabric.Line
                          ...
                          : P instanceof fabric.Triangle &&
                            ((G.angle = d.getAngle(G.x1, G.y1, G.x2, G.y2) + 90),
                            'start' == G.arrow
                              ? ((O = G.y1 + G.width / 2), (B = G.x1 + G.width / 2))
                              : 'middle' == G.arrow
                                ? ((O = G.y2 + G.width / 2 - (G.y2 - G.y1) / 2),
                                  (B = G.x2 + G.width / 2 - (G.x2 - G.x1) / 2))
                                : ((O = G.y2 + G.width / 2), (B = G.x2 + G.width / 2)),
                ...
                d.setup.fabric.on('selection:cleared', function () {
                  (d.drawing.buffer.target = !1),
                    d.drawing.buffer.isSelected && (d.setup.fabric._isCurrentlyDrawing = !1),
                ...
                d.setup.fabric.on('path:created', function (E) {
                  ...
                  if (!d.drawing.buffer.isDrawing || d.drawing.buffer.hasLine)
                    return d.setup.fabric.remove(I), void d.setup.fabric.renderAll();
                }),
                d.setup.fabric.on('object:added', function (E) {
                  ...
                  return (
                    (P = JSON.stringify(P)),
                    (I.recentState = P),
                    d.drawing.buffer.ignoreUndoOnMouseUp || !d.drawing.buffer.isDrawing
                      ? void (d.drawing.buffer.ignoreUndoOnMouseUp = !1)
                      : void (I.selectable &&
                          !I.known &&
                          !I.ignoreUndo &&
                          ((I.isAnnotation = !0),
                          d.drawing.undos.push({ action: 'added', target: I, state: P }),
                          d.drawing.undos.push({ action: 'added:modified', target: I, state: P }),
                          (d.drawing.redos = [])),
                        (I.known = !0),
                        (d.setup.fabric.isDrawingMode = !0))
                  );
                ...
                d.setup.fabric.on('object:modified', function (E) {
                  ...
                  (O = JSON.stringify(O)),
                    (I.recentState = O),
                    d.drawing.undos.push({ action: 'modified', target: I, state: O }),
                    (d.drawing.redos = []);
                }),
                d.setup.fabric.on('text:changed', function (E) {
                  ...
                  clearTimeout(I.timer),
                    (I.timer = setTimeout(function () {
                      ...
                      (I.recentState = P),
                        (d.drawing.redos = []),
                        d.drawing.undos.push({ action: 'modified', target: I, state: P });
                    }, 250));
                }),
                d.drawing.enabled
                  ? (d.setup.wrapper.setAttribute('class', d.setup.chart.classNamePrefix + '-export-canvas active'),
              ...
              'stock' == d.setup.chart.type && d.setup.chart.legendSettings.position
                ? -1 == ['top', 'bottom'].indexOf(d.setup.chart.legendSettings.position)
                  ? -1 != ['left', 'right'].indexOf(d.setup.chart.legendSettings.position) &&
                    ...
                    A.has.legend
                      ? (w.pY += d.pxToNumber(A.has.panel.style.height) + d.setup.chart.panelsSettings.panelSpacing)
                      : A.has.scrollbar && (A.offset.y -= d.setup.chart.panelsSettings.panelSpacing))
                  : A.parent.style.top && A.parent.style.left
                    ...
                    : ((A.offset.x = w.x),
                      ...
                      A.has.panel
                        ? ((w.pY = d.pxToNumber(A.has.panel.style.marginTop)), (A.offset.y += w.pY))
                ...
                : ('absolute' == A.parent.style.position
                    ? ((A.offset.absolute = !0),
                      ...
                      (A.offset.bottom = d.pxToNumber(A.parent.style.bottom, !0)),
                        ...
                        ? ('left' == A.legend.position
                            ...
                            : 'right' == A.legend.position
                              ...
                              : 'top' == A.legend.position
                                ? (w.y += A.legend.height)
                                : 'bottom' == A.legend.position && (A.offset.y = w.height - S.height),
                          (A.offset.y += w.lY),
                          (w.lY += A.legend.height))
                        : ((A.offset.x = w.x), (A.offset.y = w.y + w.pY), (w.y += d.pxToNumber(A.parent.style.height))),
                  A.has.legend && A.has.panel && A.has.panel.style.marginTop
                    ...
                    : d.setup.chart.legend &&
                      -1 != ['left', 'right'].indexOf(d.setup.chart.legend.position) &&
                      ((A.offset.y = d.pxToNumber(A.parent.style.top)),
                      (A.offset.x = d.pxToNumber(A.parent.style.left)))),
                  ...
                  (function (E) {
                    return function (I, P) {
                      ...
                      for (
                        E.offset.absolute
                          ? ((U.top =
                              void 0 === E.offset.bottom ? E.offset.top : w.height - E.offset.height - E.offset.bottom),
                            (U.left =
                              void 0 === E.offset.right ? E.offset.left : w.width - E.offset.width - E.offset.right))
                        ...
                        if (G.paths[O]) {
                          ...
                          if (G.paths[O].fill instanceof Object)
                            'radial' == G.paths[O].fill.type &&
                              ...
                              ((G.paths[O].fill.coords.r2 = -1 * G.paths[O].fill.coords.r1),
                              (G.paths[O].fill.coords.r1 = 0),
                              G.paths[O].set({ opacity: G.paths[O].fillOpacity }));
                            ...
                            N.included++,
                              fabric.Image.fromURL(
                                ...
                                (function (Z, Q) {
                                  return function ($) {
                                    N.loaded++,
                                      $.set({ top: Z.offsetY, left: Z.offsetX, width: Z.width, height: Z.height }),
                                      d.setup.fabric._isRetinaScaling() &&
                                        $.set({ top: Z.offsetY / 2, left: Z.offsetX / 2, scaleX: 0.5, scaleY: 0.5 });
                              ...
                              clipTo: (function (Z, Q) {
                                return function ($) {
                                  ...
                                  'map' == d.setup.chart.type &&
                                    ((ae.top += ee.transform[5]), (ae.left += ee.transform[4])),
                                    ee.bbox.x && te[4] && ee.bbox.y && te[5] && ((ae.top -= te[5]), (ae.left -= te[4])),
                                    void 0 !== d.setup.chart.smoothCustomBullets &&
                                    this.className == d.setup.chart.classNamePrefix + '-graph-bullet' &&
                                    'image' == G.paths[Z].svg.tagName
                                      ? ((radius = ee.svg.firstChild.rx.baseVal.value / 2 + 2),
                                        $.beginPath(),
                                        $.moveTo(ae.left + radius, ae.top),
                                        $.lineTo(ae.left + ae.width - radius, ae.top),
                                        $.quadraticCurveTo(
                                          ae.left + ae.width,
                                          ae.top,
                                          ae.left + ae.width,
                                        ...
                                        $.lineTo(ae.left + ae.width, ae.top + ae.height - radius),
                                        $.quadraticCurveTo(
                                          ae.left + ae.width,
                                          ae.top + ae.height,
                                        ...
                                        $.lineTo(ae.left + radius, ae.top + ae.height),
                                        $.quadraticCurveTo(
                                          ae.left,
                                          ae.top + ae.height,
                                          ae.left,
                                        ...
                                        $.quadraticCurveTo(ae.left, ae.top, ae.left + radius, ae.top),
                                        $.closePath())
                                      : $.rect(ae.left, ae.top, ae.width, ae.height);
                                };
                              })(O, H),
                            }));
                        }
                      ...
                      if ((m.pop(), !m.length))
                        var q = +new Date(),
                          K = setInterval(function () {
                            var Z = +new Date();
                            (N.loaded == N.included || Z - q > d.config.fabric.loadTimeout) &&
                              (clearTimeout(K),
                              d.handleBorder(h),
                  ...
                  function (E, I) {
                    ...
                    for (P = 0; P < z.length; P++) {
                      ...
                      'hidden' == B && ((I.opacity = 0), (X = 0)),
                        W &&
                          (W.pop(), W.push(X), (I[U] = 'rgba(' + W.join() + ')'), (I[U + d.capitalize('opacity')] = X));
                    }
          ...
          toImage: function (c, u) {
            var f = d.deepMerge({ format: 'png', quality: 1, multiplier: d.config.multiplier }, c || {}),
              h = f.data,
          ...
          toBlob: function (c, u) {
            ...
            return (
              m &&
                ...
                (f.data = d.toByteArray({ data: f.data.slice(f.data.indexOf(',') + 1, f.data.length) }))),
              (h = f.getByteArray ? f.data : new Blob([f.data], { type: f.type })),
          ...
          toJPG: function (c, u) {
            ...
            return (
              ...
              !!d.handleNamespace('fabric', { scope: this, cb: d.toJPG, args: arguments })) &&
              ((h = d.setup.fabric.toDataURL(f)), d.handleCallback(u, h, f), h)
            );
          },
          toPNG: function (c, u) {
            var h,
              f = d.deepMerge({ format: 'png', quality: 1, multiplier: d.config.multiplier }, c || {});
            return (
              (/iP(hone|od|ad)/.test(navigator.platform) && (f.multiplier = 1),
              !!d.handleNamespace('fabric', { scope: this, cb: d.toPNG, args: arguments })) &&
              ((h = d.setup.fabric.toDataURL(f)), d.handleCallback(u, h, f), h)
            );
          },
          toSVG: function (c, u) {
                  ...
                  reviver: function (T, A) {
                    ...
                    if (((T = T.replace(F, E.join(';'))), A && A.svg)) {
                      ...
                      if (
                        ((_ = _ ? _.split(' ') : []),
                        (T =
                          -1 == _.indexOf(d.setup.chart.classNamePrefix + '-graph-line')
                            ? '<g ' + W + '>' + T + '</g>'
                            : X + W + H),
                        -1 == h.indexOf(z))
                      ) {
          ...
          toPDF: function (c, u) {
            function f(A) {
              ...
              else if (2 === A.length) A = { left: A[0], top: A[1], right: A[0], bottom: A[1] };
              else if (4 === A.length) A = { left: A[0], top: A[1], right: A[2], bottom: A[3] };
            ...
            var w,
              m = d.deepMerge(
                d.deepMerge(
                  { multiplier: d.config.multiplier || 2, pageOrigin: void 0 === d.config.pageOrigin },
                  d.config.pdfMake,
                ),
                c || {},
                !0,
            ...
            if (
              ...
              !d.handleNamespace('pdfMake', { scope: this, cb: d.toPDF, args: arguments }))
            )
              return !1;
            if (((m.images.reference = d.toPNG(m)), !m.content)) {
              ...
              (S[0] -= T.left + T.right),
                (S[1] -= T.top + T.bottom),
                m.pageOrigin &&
                  (N.push(d.i18l('label.saved.from')), N.push(window.location.href), (S[1] -= 2 * 14.064)),
          ...
          toJSON: function (c, u) {
            var f = d.deepMerge({ dateFormat: d.config.dateFormat || 'dateObject' }, c || {}, !0),
              h = {};
            return (
              !!d.handleNamespace('JSON', { scope: this, cb: d.toJSON, args: arguments }) &&
          ...
          toCSV: function (c, u) {
            var m = d.deepMerge({ delimiter: ',', quotes: !0, escape: !0, withHeader: !0 }, c || {}, !0),
              w = [],
              N = '';
            return (
              (w = d.toArray(m)),
          ...
          toXLSX: function (c, u) {
            ...
            var m = d.deepMerge(
                { name: 'amCharts', dateFormat: d.config.dateFormat || 'dateObject', withHeader: !0, stringify: !1 },
                c || {},
                !0,
              ),
              w = [],
            ...
            return (
              ...
              (S.Sheets[m.name] = (function (T) {
                for (var M = {}, F = { s: { c: 1e7, r: 1e7 }, e: { c: 0, r: 0 } }, D = 0; D != T.length; ++D)
                    ...
                    if (null != I.v) {
                      ...
                      'number' == typeof I.v
                        ...
                        : 'boolean' == typeof I.v
                          ? (I.t = 'b')
                          : I.v instanceof Date
                            ? ((I.t = 'n'), (I.z = XLSX.SSF._table[14]), (I.v = f(I.v)))
              ...
              (N = XLSX.write(S, { bookType: 'xlsx', bookSST: !0, type: 'base64' })),
              (N = 'data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,' + N),
              d.handleCallback(u, N, m),
              N)
            );
          },
          toArray: function (c, u) {
            function h(F) {
              return (
                'string' == typeof F &&
                  (N.escape && (F = F.replace('"', '""')), N.quotes && (F = ['"', F, '"'].join(''))),
                F
              );
            }
            var w,
              N = d.deepMerge({ withHeader: !1, stringify: !0, escape: !1, quotes: !1 }, c || {}, !0),
              S = [],
              T = [],
              A = [],
            ...
            return (
              ...
              (N.data = void 0 === N.data ? d.getChartData(N) : d.processData(N)),
              N.withHeader &&
                ((A = []),
          ...
          toByteArray: function (c, u) {
            ...
            var m = d.deepMerge({}, c || {}),
              ...
              F = (function (D) {
                ...
                var U = D.length;
                (G = '=' === D.charAt(U - 2) ? 2 : '=' === D.charAt(U - 1) ? 1 : 0),
                ...
                return (
                  2 === G
                    ? ((B = (f(D.charAt(I)) << 2) | (f(D.charAt(I + 1)) >> 4)), E(255 & B))
                    : 1 == G &&
                      ((B = (f(D.charAt(I)) << 10) | (f(D.charAt(I + 1)) << 4) | (f(D.charAt(I + 2)) >> 2)),
                      E(255 & (B >> 8)),
                      E(255 & B)),
                  z
                );
          ...
          handleNamespace: function (c, u) {
              ...
              (m = !!(c in h)),
                ...
                m
                  ? (clearTimeout(N),
                    ...
                    d.handleLog(['AmCharts [export]: Namespace "', c, '" showed up in: ', h + ''].join('')))
                  : S - w < d.libs.loadTimeout
                    ? (N = setTimeout(f, 250))
                    : d.handleLog(['AmCharts [export]: Gave up waiting for "', c, '" in: ', h + ''].join(''));
            }
            var N,
            ...
            return (
              (m = !!(c in h)),
              m || (d.handleLog(['AmCharts [export]: Could not find "', c, '" in: ', h + ''].join('')), f()),
              m
            );
          },
          ...
          handleDropbox: function (c) {
            if (d.drawing.enabled)
              if ((c.preventDefault(), c.stopPropagation(), 'dragover' == c.type))
                ...
                (function (S) {
                  var T = setInterval(function () {
                    ...
                    (A - m > h.libs.loadTimeout || S in window) &&
                      (clearTimeout(T), h.handleCallback(c, S, A - m > h.libs.loadTimeout));
                  }, AmCharts.updateRate);
                })(N);
              });
          },
          getChartData: function (c) {
            function u(U, H, X) {
              ...
              U &&
                ...
                ((h = W(U, X)), (f.dataFieldsMap[h] = U), f.dataFields.push(h), (f.titles[h] = H || h));
            }
            var h,
              m,
              w,
            ...
            if (0 == f.data.length)
              if ('stock' == d.setup.chart.type) {
                for (
                  f.data = d.cloneObject(d.setup.chart.mainDataSet.dataProvider),
                ...
                for (
                  f.data = d.setup.chart.dataProvider,
                    d.setup.chart.categoryAxis &&
                      (u(d.setup.chart.categoryField, d.setup.chart.categoryAxis.title),
                      !1 !== d.setup.chart.categoryAxis.parseDates && f.dateFields.push(d.setup.chart.categoryField)),
                    m = 0;
              ...
              for (f = 0; f < u.data.length; f++) {
                ...
                for (h = 0; h < u.dataFields.length; h++) {
                  var S = u.dataFields[h],
                    ...
                    M = u.data[f][T];
                  null == M && (M = void 0),
                    u.exportTitles && 'gantt' != d.setup.chart.type && A in w && (A += ['( ', S, ' )'].join('')),
                    -1 != u.dateFields.indexOf(T) &&
                      (u.dataDateFormat && (M instanceof String || 'string' == typeof M)
                        ? (M = AmCharts.stringToDate(M, u.dataDateFormat))
                        : u.dateFormat && (M instanceof Number || 'number' == typeof M) && (M = new Date(M)),
                      u.exportSelection &&
                        (M instanceof Date
              ...
              for (S = 0; S < w.length; S++) {
                ...
                if (
                  ...
                  d.config.formats[M.format]
                    ...
                    : !M.label && (M.label = M.label ? M.label : d.i18l('menu.label.' + P)),
                  -1 != ['CSV', 'JSON', 'XLSX'].indexOf(M.format) && -1 != ['map', 'gauge'].indexOf(d.setup.chart.type))
                )
                  continue;
                else if (
                  !d.setup.hasBlob &&
                ...
                if ('draw' == M.action)
                  d.config.fabric.drawing.enabled
                    ? ((M.menu = M.menu ? M.menu : d.config.fabric.drawing.menu),
                      (M.click = (function (H) {
                        return function () {
                        ...
                        (M.click = (function (H) {
                          return function () {
                            this.drawing.handler[H.action](H),
                              'cancel' != H.action && this.createMenu(this.config.fabric.drawing.menu);
                          };
                        })(M)))
                      : d.drawing.enabled
                        ? (M.click = (function (H) {
                        ...
                        : 'UNDEFINED' != M.format &&
                          (M.click = (function (H) {
                            return function () {
                              if (H.capture || 'print' == H.action || 'PRINT' == H.format)
                                this.capture(H, function () {
                ...
                (void 0 === M.menu || M.menu.length) &&
                        ...
                        (function (H, X) {
                          return function (W) {
                            ...
                            return ('draw' != X.action &&
                              ...
                              ? void H.apply(d, [W, X])
                              : ((X.delay = isNaN(X.delay) ? d.config.delay : X.delay), void d.delay(X, H));
                          };
                        })(
                          M.click ||
                            function (H) {
                  ...
                  F.appendChild(D),
                  d.isElement(M.label) ? I.appendChild(M.label) : (I.innerHTML = M.label),
                  M['class'] && (F.className = M['class']),
                  M.style && F.setAttribute('style', M.style),
                  M.icon &&
                    (E.setAttribute(
                      'src',
                      (M.ignore || -1 != M.icon.slice(0, 10).indexOf('//') ? '' : t.pathToImages) + M.icon,
                    ),
                    D.appendChild(E)),
                  M.label && D.appendChild(I),
                  M.title && D.setAttribute('title', M.title),
                  d.config.menuReviver && (F = d.config.menuReviver.apply(d, [M, F])),
                  (M.elements = { li: F, a: D, img: E, span: I }),
                  (M.menu || M.items) && 'draw' != M.action
                    ? f(M.menu || M.items, F).childNodes.length && A.appendChild(F)
                    : A.appendChild(F));
              }
            ...
            return (
              u ||
                ('string' == typeof d.config.divId
                  ? (d.config.divId = u = document.getElementById(d.config.divId))
          ...
          delay: function (c, u) {
              ...
              N = d.createMenu([
                {
                  label: d
                    ...
                    .replace('{{duration}}', AmCharts.toFixed(f.delay, f.precision)),
            ...
            (h = setInterval(function () {
              ...
              0 >= T
                ? (clearTimeout(h), 'draw' != f.action && d.createMenu(d.config.menu))
                : S &&
                  (S.innerHTML = d
                    .i18l('capturing.delayed.menu.label')
          ...
          clear: function () {
            var c, u;
            for (
              void 0 !== d.setup.fabric && d.setup.fabric.removeListeners(), c = 0;
          ...
          loadListeners: function () {
            ...
            d.config.keyListener &&
              ...
              ((d.docListener = function (u) {
                ...
                function h(D) {
                  d.setup.focusedMenuItem &&
                    ...
                    f(d.setup.focusedMenuItem.nextSibling.getElementsByTagName('a'), D));
                }
                function m(D) {
                  d.setup.focusedMenuItem &&
                    d.setup.focusedMenuItem.parentNode.parentNode.parentNode &&
                    (d.setup.focusedMenuItem.parentNode.classList.add('active'),
                    f(d.setup.focusedMenuItem.parentNode.parentNode.parentNode.getElementsByTagName('a'), D));
                }
                function w(D) {
                  d.setup.focusedMenuItem &&
                    d.setup.focusedMenuItem.parentNode.nextSibling &&
                    (d.setup.focusedMenuItem.parentNode.classList.remove('active'),
                    f(d.setup.focusedMenuItem.parentNode.nextSibling.getElementsByTagName('a'), D));
                }
                function N(D) {
                  d.setup.focusedMenuItem &&
                    d.setup.focusedMenuItem.parentNode.previousSibling &&
                    (d.setup.focusedMenuItem.parentNode.classList.remove('active'),
                    f(d.setup.focusedMenuItem.parentNode.previousSibling.getElementsByTagName('a'), D));
                }
                function S() {
                  function D(E) {
                    if (d.isElement(E)) {
                      ...
                      E.parentNode && E.parentNode.classList.remove('active'),
                        E.classList.contains('amExportButton') || D(E.parentNode);
                    }
                  }
                ...
                if (d.setup.focusedMenuItem && -1 != [37, 38, 39, 40, 13, 9, 27].indexOf(u.keyCode)) {
                  if (9 == u.keyCode)
                    return void (d.setup.focusedMenuItem.nextSibling
                      ? u.shiftKey && d.setup.focusedMenuItem.parentNode.classList.remove('active')
                      : (d.setup.focusedMenuItem.parentNode.classList.remove('active'),
                        !d.setup.focusedMenuItem.parentNode.nextSibling &&
                          (d.setup.focusedMenuItem.parentNode.classList.remove('active'),
                          d.setup.focusedMenuItem.parentNode.parentNode.parentNode.classList.remove('active'))));
                ...
                (8 == u.keyCode || 46 == u.keyCode) && T
                  ...
                  : 27 == u.keyCode && d.drawing.enabled
                    ? (u.preventDefault(),
                      d.drawing.buffer.isSelected ? d.setup.fabric.discardActiveObject() : d.drawing.handler.done())
                    : 67 == u.keyCode && (u.metaKey || u.ctrlKey) && T
                      ...
                      : 88 == u.keyCode && (u.metaKey || u.ctrlKey) && T
                        ...
                        : 86 == u.keyCode && (u.metaKey || u.ctrlKey)
                          ...
                          : 90 == u.keyCode &&
                            (u.metaKey || u.ctrlKey) &&
                            (u.preventDefault(), u.shiftKey ? d.drawing.handler.redo() : d.drawing.handler.undo());
              }),
              ...
              d.config.fileListener &&
                ...
                d.addListenerToRemove('dragover', d.setup.chart.containerDiv, d.handleDropbox),
                d.setup.chart.containerDiv.addEventListener('dragleave', d.handleDropbox),
                d.addListenerToRemove('dragleave', d.setup.chart.containerDiv, d.handleDropbox),
                d.setup.chart.containerDiv.addEventListener('drop', d.handleDropbox),
                d.addListenerToRemove('drop', d.setup.chart.containerDiv, d.handleDropbox));
          },
          init: function () {
            clearTimeout(s),
              (s = setInterval(function () {
                d.setup &&
                  ...
                  d.config.enabled &&
                    ...
                    d.config.overflow && (d.setup.chart.div.style.overflow = 'visible'),
                    d.loadListeners(),
                    d.createMenu(d.config.menu),
          ...
          construct: function () {
            ...
            (window.safari = window.safari ? window.safari : {}),
              ...
              d.setup.hasClasslist || d.libs.resources.push('classList.js/classList.min.js'),
              d.isSupported() &&
