            ...
            if (!1 === s) l(n.error, n, t), i(AmCharts.__('Error loading the file', t.language) + ': ' + r, !1, n);
              ...
              switch ((void 0 === n.format && (n.format = 'json'), (n.format = n.format.toLowerCase()), n.format)) {
                case 'json':
                  if (((o[u] = AmCharts.parseJSON(s)), !1 === o[u]))
                    return (
                      l(n.error, n, t),
                      i(AmCharts.__('Error parsing JSON file', t.language) + ': ' + c.url, !1, n),
                      void (o[u] = [])
                    );
                ...
                case 'csv':
                  if (((o[u] = AmCharts.parseCSV(s, n)), !1 === o[u]))
                    return (
                      l(n.error, n, t),
                      i(AmCharts.__('Error parsing CSV file', t.language) + ': ' + c.url, !1, n),
                      void (o[u] = [])
                    );
                  (o[u] = a(o[u], n)), l(n.load, n, t);
                  break;
                default:
                  return (
                    l(n.error, n, t),
                    void i(AmCharts.__('Unsupported data format', t.language) + ': ' + n.format, !1, n.noStyles)
                  );
              }
              if ((c.remaining--, 0 === c.remaining && (l(n.complete, t), n.async)))
                if ('map' === t.type) t.validateNow(!0), d();
                  ...
                  'gauge' === t.type ? (d(), t.validateNow()) : t.validateData(),
                  c.startDuration)
                )
                  if ('stock' === t.type) {
      ...
      function s(e, a) {
        ...
        if ((r.setAttribute('id', t.div.id + '-curtain'), (r.className = 'amcharts-dataloader-curtain'), !0 !== a)) {
          (r.style.position = 'absolute'),
            (r.style.top = 0),
            (r.style.left = 0),
            (r.style.width = (void 0 !== t.realWidth ? t.realWidth : t.divRealWidth) + 'px'),
            (r.style.height = (void 0 !== t.realHeight ? t.realHeight : t.divRealHeight) + 'px'),
          ...
          if ('stock' === t.type)
            setTimeout(function () {
              0 > t.panelsSettings.startDuration &&
                ((c.startDuration = t.panelsSettings.startDuration), (t.panelsSettings.startDuration = 0));
              for (var a = 0; a < t.dataSets.length; a++) {
                ...
                void 0 !== r.dataLoader &&
                  ...
                  void 0 !== r.eventDataLoader &&
                    ...
                    (r.events = []),
                    o(r.eventDataLoader),
                    e(r.eventDataLoader.url, r, r.eventDataLoader, 'stockEvents'));
              }
            }, 100);
          else {
            ...
            void 0 !== t.startDuration &&
              ...
              'gauge' === t.type
                ? (void 0 === t.arrows && (t.arrows = []), e(c.url, t, c, 'arrows'))
                : (void 0 === t.dataProvider && (t.dataProvider = 'map' === t.type ? {} : []),
    ...
    void 0 !== e.progress &&
      ...
      (r.onreadystatechange = function () {
        4 !== r.readyState || (404 !== r.status && 500 !== r.status)
          ? 4 === r.readyState && 200 === r.status && a.call(this, r.responseText)
          : a.call(this, !1);
      });
    try {
      r.send();
    ...
    for (var l; (l = e.reverse ? o.pop() : o.shift()); )
      if (!e.skipEmpty || 1 !== l.length || '' !== l[0]) {
        ...
        for (r = 0; r < l.length; r++)
          (u[(a = void 0 === s[r] ? 'col' + r : s[r])] = '' === l[r] ? e.emptyAs : l[r]),
