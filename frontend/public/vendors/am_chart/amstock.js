(function () {
  ...
  e.AmStockChart = e.Class({
        ...
        if (e.ifArray(d)) {
          ...
          b.dataParsed ||
            ...
            0 < a.processTimeout
              ...
              : a.parseStockData(b, c.minPeriod, c.groupToPeriods, a.firstDayOfWeek, a.dataDateFormat));
    ...
    onDataUpdated: function () {
      this.isDataParsed() &&
        (this.updatePanelsWithNewData(), this.skipEvents || this.fire({ type: 'dataUpdated', chart: this }));
    },
    ...
    parseStockData: function (a, b, c, d, k) {
          ...
          for (z = f; z < m; z++) {
            ...
            if (z == f || C >= y[p] || !y[p]) {
              ...
              z > f &&
                ...
                (y[p] = u.getTime()));
              if (z == f) for (var I in B) B.hasOwnProperty(I) && (v[p][I] = B[I]);
              v[p][n] = e.newDate(D, b);
            } else
      ...
      e.ifArray(a.stockEvents)
        ? 0 < g.processTimeout
          ...
          : g.parseEvents(a, g.panels, g.stockEventsSettings, g.firstDayOfWeek, g, g.dataDateFormat)
          ...
          for (b = l[y], h = e.extractPeriod(y), n = b.length, f = 0; f < d.length; f++) {
            ...
            v &&
              ...
              q &&
                ...
                isNaN(m.borderAlpha) ? p.borderAlphas.push(c.borderAlpha) : p.borderAlphas.push(m.borderAlpha),
                void 0 !== m.borderColor ? p.borderColors.push(m.borderColor) : p.borderColors.push(c.borderColor),
                void 0 !== m.rollOverColor
                  ? p.rollOverColors.push(m.rollOverColor)
                  : p.rollOverColors.push(c.rollOverColor),
                void 0 !== m.showAt ? p.showAts.push(m.showAt) : p.showAts.push(c.showAt),
    ...
    getEventDataItem: function (a, b, c, d, k, g) {
      ...
      l =
        'fff' == l
          ? m.getTime() + 1
          : e.resetDateToMin(e.changeDate(new Date(m), g.period, g.count), l, h, this.firstDayOfWeek).getTime();
      if (a >= q && a < l) return f;
      if (!(1 >= k - d))
          ...
          for (b = 0; b < a.length; b++)
            if ((g = a[b]))
              (g.percentHeight = (g.percentHeight / d) * 100),
                g.panelBox &&
                  (g.panelBox.style.height = Math.round((g.percentHeight * this.panelsHeight) / 100) + 'px');
          this.prevPH = c;
        }
      }
    },
    ...
    addCursor: function (a) {
      ...
      if (b.enabled) {
        ...
        a.chartCursor &&
          ...
          a.chartCursor.categoryBalloonFunction && (d = a.chartCursor.categoryBalloonFunction));
    ...
    zoomChart: function (a, b) {
      ...
      if (k && g) {
        ...
        if (l) {
          ...
          a.getTime() == b.getTime() &&
            v != n &&
            ((b = e.changeDate(b, v.period, v.count)), b.setTime(b.getTime() - 1));
        }
        ...
        c.extendToFullPeriod &&
          (v.getTime() - k.getTime() < 0.1 * A && (v = e.resetDateToMin(a, n.period, n.count, y)),
          g.getTime() - b.getTime() < 0.1 * A &&
            ((b = e.resetDateToMin(g, n.period, n.count, y)), (b = e.changeDate(b, n.period, n.count, !0))));
        ...
        for (k = 0; k < q.length; k++) {
          ...
          if (l != h) {
            ...
            if ((d = g.chartCursor))
              (d.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(n.period)),
    ...
    dispDUpd: function () {
      this.skipEvents ||
        ...
        this.chartRendered || ((this.chartRendered = !0), this.fire({ type: 'rendered', chart: this })),
          ...
          for (l = 0; l < g.length; l++) {
              ...
              if (f.valueAxis) {
                ...
                for (D = 0; D < B; D++) {
                  ...
                  f.compareGraph &&
                    ...
                    f.compareGraph.balloon && ((r.balloon = {}), e.copyProperties(f.compareGraph.balloon, r.balloon)));
                  ...
                  if (m) {
                    ...
                    p &&
                      (t && y
                        ? ((r.legendValueTextR = y), (r.legendPeriodValueTextR = A))
                        : (v && (r.legendValueTextR = v), (r.legendPeriodValueTextR = E)));
            ...
            p &&
              (t && y
                ...
                : (v && (f.legendValueTextR = v), (f.legendPeriodValueTextR = E)));
          }
        }
      }
    },
    ...
    removePanel: function (a) {
      ...
      for (c = b.length - 1; 0 <= c; c--)
        b[c] == a &&
          (this.fire({ type: 'panelRemoved', panel: a, chart: this }), b.splice(c, 1), a.destroy(), a.clear());
    },
    ...
    validateSizeReal: function () {
      ...
      if (this.divRealWidth != this.previousWidth || this.divRealHeight != this.previousHeight)
        0 < this.divRealWidth && 0 < this.divRealHeight && this.fire({ type: 'resized', chart: this }),
      ...
      f &&
        ...
        ('MAX' == g
          ...
          : 'YTD' == g
            ...
            : 'YYYY' == g || 'MM' == g
              ? h
                ? ((h = f), (n = new Date(f)), 'YYYY' == g && (k *= 12), n.setMonth(n.getMonth() + k))
                : ((h = new Date(m)),
                  'YYYY' == g && ((g = 'MM'), (k *= 12)),
                ...
                ? (e.getPeriodDuration(g, k),
                  ...
                  h
                    ...
                    : ((h = new Date(m.getTime())),
                      ...
                      (n = this.lastDate)))
                : ((q = e.getPeriodDuration(g, k)),
                  h ? ((h = f), (n = new Date(f.getTime() + q - 1))) : ((h = new Date(m.getTime() - q + 1)), (n = m))),
        (a.startTime = h.getTime()),
        this.hideOutOfScopePeriods &&
          (b && a.startTime < f.getTime() ? (d.style.display = 'none') : (d.style.display = 'inline')),
        h.getTime() > m.getTime() && ((q = e.getPeriodDuration('DD', 1)), (h = new Date(m.getTime() - q))),
        h.getTime() < f.getTime() && (h = f),
        'YTD' == g &&
          ((a.startTime = h.getTime()), m.getFullYear() < new Date().getFullYear() && (d.style.display = 'none')),
        (a.endTime = n.getTime()),
        b ||
          ((this.skipMark = !0),
          this.unselectButtons(),
          (d.className = 'amChartsButtonSelected ' + l.classNamePrefix + '-period-input-selected'),
      ...
      if (!this.skipMark) {
        ...
        for (g = b.length - 1; 0 <= g; g--) {
          ...
          l.startTime &&
            ...
            d == l.endTime &&
            (this.unselectButtons(),
            (h.className = 'amChartsButtonSelected ' + a.classNamePrefix + '-period-input-selected'),
  ...
  e.DataSetSelector = e.Class({
    ...
    write: function (a) {
      ...
      if (0 < b.countDataSets('showInCompare') && 1 < g.length)
        if (
          (l ? (e.addBr(a), e.addBr(a)) : ((c = document.createTextNode(' ')), a.appendChild(c)),
          ...
          for (c = 0; c < g.length; c++)
            (n = g[c]),
              !0 === n.showInCompare &&
                ...
                (d.dataSet = n),
                (d.style.height = f + 'px'),
                n.compared && (d.style.backgroundColor = b.selectedBackgroundColor),
                h.appendChild(d),
                (l = document.createElement('div')),
                (l.style.width = f + 'px'),
                (l.style.height = f + 'px'),
...
(function () {
  ...
  e.StackedBullet = e.Class({
    ...
    addLetter: function (a, b, c) {
      ...
      this.bullets[c] = v;
      this.showOnAxis
        ? ((m = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY), (f = h * k), (this.nextAxisY = m + k * d))
        : this.value
          ? ((m = this.value),
          ...
          : this.showAt
            ? ((v = this.graphDataItem.values),
              ...
              v && ((m = l.getCoordinate(v[this.showAt]) - this.bulletY), (f = h * k)))
            : ((m = this.nextY), (f = h * k));
      a.translate(n, f);
      b.push(a);
      b.translate(0, m);
    ...
    handleMouseOver: function (a, b) {
      ...
      c = d.graphs;
      if (d.chartCursor && d.chartCursor.valueBalloonsEnabled) for (k = 0; k < c.length; k++) c[k].hideBalloon();
    },
    handleClick: function (a) {
