...
!(function (t, e) {
  ...
  function p(t) {
    ...
    return (
      ...
      (e =
        (e = 3.2406 * a + -1.5372 * o + -0.4986 * r) > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : (e *= 12.92)),
  ...
  st._set('global', {
    elements: {
      arc: { backgroundColor: st.global.defaultColor, borderColor: '#fff', borderWidth: 2, borderAlign: 'center' },
    },
  });
  var _t = pt.extend({
        ...
        for (
          ...
          (e = s[t]),
            ...
            0 === t
              ...
              : ((i = -1 === u ? i : s[u]),
                n.skip ||
                  ((u !== t - 1 && !r) || -1 === u ? o.moveTo(n.x, n.y) : ut.canvas.lineTo(o, i._view, e._view),
                  (u = t)));
        o.stroke(), o.restore();
      },
    }),
    ...
    var n,
      ...
      l = (function (t) {
        var e = t.borderSkipped,
          i = {};
        return e
          ? (t.horizontal ? t.base > t.x && (e = Ot(e, 'left', 'right')) : t.base < t.y && (e = Ot(e, 'bottom', 'top')),
            (i[e] = !0),
            i)
          : i;
      })(t);
          ...
          this._plugins.concat(a.plugins || []).forEach(function (t) {
            if (-1 === i.indexOf(t)) {
              var e = t.id,
                a = o[e];
              !1 !== a &&
                (!0 === a && (a = ut.clone(st.global.plugins[e])), i.push(t), n.push({ plugin: t, options: a || {} }));
            }
          }),
          (e.descriptors = n),
          (e.id = this._cacheId),
            ...
            ut.each(t.ticks, function (e, s) {
              if (s > 0 || n.reverse) {
                ...
                if (
                    ...
                    (function (t, e, i, n) {
                      ...
                      if ((r || s) && l && d) {
                        if (
                          ...
                          (o.lineWidth = d),
                          o.setLineDash &&
                            (o.setLineDash(e.borderDash || []), (o.lineDashOffset = e.borderDashOffset || 0)),
                          o.beginPath(),
                          r)
                        )
                  ...
                  if (
                    ((a.font = r.string), a.save(), a.translate(t.xCenter, t.yCenter), a.rotate(o), n.showLabelBackdrop)
                  ) {
              ...
              for (t.beginPath(), r = 0, s = f + !!o; r < s; ++r)
                (u = i((d = e[(l = r % f)]._view), l, n)),
                  ...
                  h && c
                    ...
                    : v &&
                      b &&
                      (g ? (h && p.push(d), c && m.push(u)) : (dn(t, p, m, v, b), (v = b = 0), (p = []), (m = [])));
  ...
  var gn = pt.extend({
    ...
    fit: function () {
      var t = this,
        ...
        d = t.isHorizontal();
      if (
        (d ? ((l.width = t.maxWidth), (l.height = n ? 10 : 0)) : ((l.width = n ? 10 : 0), (l.height = t.maxHeight)), n)
      )
