...
(gj.widget = function () {
  ...
  (gj.grid.methods = {
    ...
    renderRow: function (a, b, c, d) {
      ...
      for (
        h = a.data(),
          b && 0 !== b.length
            ? ((i = 'update'), b.removeClass(h.style.content.rowSelected).removeAttr('data-selected').off('click'))
        ...
        if (c.editor) {
          if (
            ...
            if ('function' == typeof c.editor) c.editor(f, h, d), (g = f.find('input, select, textarea').first());
              ...
              switch (
                ((g = $('<input type="text" width="100%"/>')), f.append(g), c.format && (i.format = c.format), c.type)
              ) {
                case 'date':
                  g = g.datepicker(i);
                  break;
  ...
  (gj.tree.methods = {
    ...
    appendNode: function (a, b, c, d, e) {
      ...
      if (
        ...
        k.indentation &&
          $wrapper.append('<span data-role="spacer" style="width: ' + k.indentation * (d - 1) + 'px;"></span>'),
        disabled
              ...
              e.each(function () {
                ...
                if (k.droppable('isOver', g))
                  return (
                    ...
                    !1 !==
                      gj.tree.plugins.dragAndDrop.events.nodeDrop(a, e, i.parent('ul').parent('li').data('id'), d) &&
                      ((h = a.getDataById(b.data('id'))),
                      gj.tree.methods.removeDataById(a, b.data('id'), f.records),
            ...
            : '40' == d.keyCode
              ...
              : '37' == d.keyCode
                ? ((i = j.prev('td[day]:not(.disabled)')),
                  ...
                  0 === i.length &&
                    (gj.datepicker.methods.prev(a, c)(), (i = b.find('tbody tr').last().find('td[day]').last())),
                ...
                : '39' == d.keyCode
                  ? ((i = j.next('[day]:not(.disabled)')),
                    ...
                    0 === i.length &&
                      (gj.datepicker.methods.next(a, c)(), (i = b.find('tbody tr').first().find('td[day]').first())),
                    i.length > 0 && (i.addClass('focused'), j.removeClass('focused')))
                  : '13' == d.keyCode
  ...
  (gj.colorpicker.methods = {
    init: function (a) {
      return (
        gj.picker.widget.prototype.init.call(this, a, 'colorpicker'), gj.colorpicker.methods.initialize(this), this
      );
    },
    initialize: function (a) {},
