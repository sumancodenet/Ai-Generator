...
(function (global, factory) {
        ...
        if (this.options.codeviewIframeFilter) {
          ...
          value = value.replace(/(<iframe.*?>.*?(?:<\/iframe>)?)/gi, function (tag) {
            ...
            for (var _i = 0, whitelist_2 = whitelist_1; _i < whitelist_2.length; _i++) {
              ...
              if (
                new RegExp('src="(https?:)?//' + src.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&') + '/(.+)"').test(tag)
              ) {
                return tag;
              }
            }
  ...
  var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
      ...
      var footer =
        '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.link.insert + '" disabled>';
      this.$dialog = this.ui
        .dialog({
          className: 'link-dialog',
  ...
  var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
      ...
      var footer =
        '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.image.insert + '" disabled>';
      this.$dialog = this.ui
        .dialog({
  ...
  var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
      ...
      var footer =
        '<input type="button" href="#" class="' + buttonClass + '" value="' + this.lang.video.insert + '" disabled>';
      this.$dialog = this.ui
        .dialog({
