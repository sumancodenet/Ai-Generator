          ...
          function r() {
            c ||
              (c = setInterval(function () {
                return i.get(t)
                  ? (a(t, 'top', t.scrollTop + u.top), a(t, 'left', t.scrollLeft + u.left), void l(t))
      ...
      function (t, e, n) {
        ...
        function r(t) {
          ...
          (r.settings = a.clone(c)),
            ...
            (r.railXMarginWidth =
              a.toInt(u.css(r.scrollbarXRail, 'marginLeft')) + a.toInt(u.css(r.scrollbarXRail, 'marginRight'))),
            ...
            (r.railYMarginHeight =
              a.toInt(u.css(r.scrollbarYRail, 'marginTop')) + a.toInt(u.css(r.scrollbarYRail, 'marginBottom'))),
      ...
      function (t, e, n) {
        ...
        e.exports = function (t) {
          ...
          t.contains(e.scrollbarXRail) ||
            ...
            !e.settings.suppressScrollY && e.containerHeight + e.settings.scrollYMarginOffset < e.contentHeight
              ? ((e.scrollbarYActive = !0),
                ...
                (e.scrollbarYTop = i.toInt(
                  (t.scrollTop * (e.railYHeight - e.scrollbarYHeight)) / (e.contentHeight - e.containerHeight),
                )))
            ...
            e.scrollbarXActive
              ? l.add(t, 'ps-active-x')
              : (l.remove(t, 'ps-active-x'), (e.scrollbarXWidth = 0), (e.scrollbarXLeft = 0), c(t, 'left', 0)),
            e.scrollbarYActive
              ? l.add(t, 'ps-active-y')
              : (l.remove(t, 'ps-active-y'), (e.scrollbarYHeight = 0), (e.scrollbarYTop = 0), c(t, 'top', 0));
        };
      },
      ...
      function (t, e, n) {
        ...
        e.exports = function (t) {
          ...
          e &&
            ...
            (e.railXMarginWidth =
              r.toInt(o.css(e.scrollbarXRail, 'marginLeft')) + r.toInt(o.css(e.scrollbarXRail, 'marginRight'))),
            (e.railYMarginHeight =
              r.toInt(o.css(e.scrollbarYRail, 'marginTop')) + r.toInt(o.css(e.scrollbarYRail, 'marginBottom'))),
