(function () {
  ...
  function Ub(a, b, c, d, e) {
    for (
      var f = c.length, g = f, h, k, l, m = c[0], n = 0, q = 0, t = 0, u = d / 2 || 0, y = e ? 1 : 3;
      1 != n && g > y;
  ...
  gc.prototype.distance = function (a) {
    ...
    this === a || (this.lat === a.lat && this.lng === a.lng)
      ...
      : ((b = this.lat * Ib),
        ...
        (a =
          1.274200158e7 *
          xb(lb(1, tb(ub(wb((b - c) / 2), 2) + yb(b) * yb(c) * ub(wb((this.lng * Ib - a.lng * Ib) / 2), 2))))));
    return a;
  };
      ...
      if (a.b) {
        ...
        if (c.a) {
          ...
          e &&
            (c.G == Yc && 1 == d
              ? kd(c, b)
              : (f ? ((d = f), d.next == c.c && (c.c = d), (d.next = d.next.next)) : ld(c), md(c, e, bd, b)));
        }
        a.b = null;
      } else $c(a, bd, b);
  }
  ...
  function Od(a) {
    ...
    if (!(b = Nd[a])) {
      b = 0;
      for (
        var c = Ea(String(Md)).split('.'), d = Ea(String(a)).split('.'), e = Math.max(c.length, d.length), f = 0;
        0 == b && f < e;
        f++
      ) {
        var g = c[f] || '',
        ...
        do {
          ...
          b =
            Fa(0 == m[1].length ? 0 : parseInt(m[1], 10), 0 == n[1].length ? 0 : parseInt(n[1], 10)) ||
  ...
  function ge(a, b) {
    ...
    if (!Ud) {
      ...
      if (!(0 > c.keyCode || void 0 != c.returnValue)) {
        ...
        for (h = 0; !d.a && h < c.length; h++) (d.currentTarget = c[h]), (k = ke(c[h], f, !1, d)), (e = e && k);
      }
      return e;
    }
  ...
  p.dispatchEvent = function (a) {
    ...
    var e = !0,
      f;
    if (b) for (var g = b.length - 1; !a.a && 0 <= g; g--) (f = a.currentTarget = b[g]), (e = f.dc(d, !0, a) && e);
    a.a || ((f = a.currentTarget = c), (e = f.dc(d, !0, a) && e), a.a || (e = f.dc(d, !1, a) && e));
    if (b) for (g = 0; !a.a && g < b.length; g++) (f = a.currentTarget = b[g]), (e = f.dc(d, !1, a) && e);
    return e;
  };
  p.D = function () {
    I.u.D.call(this);
      ...
      'none' === a
        ...
        : ((te.fillStyle = 'black'),
          ...
          qe.test(te.fillStyle)
            ...
            : (te.clearRect(0, 0, 1, 1), te.fillRect(0, 0, 1, 1), (b = te.getImageData(0, 0, 1, 1).data))),
      (se[a] = b));
    return b;
  }
  function ue(a) {
  ...
  function Fe(a, b, c) {
    ...
    if (c) for (a = Ee(a), c = Ee(b), d = c.length; d--; ) c[d].getContext('2d').drawImage(a[d], 0, 0);
    return b;
  }
  function Ge(a) {
  ...
  function cf(a, b) {
    var c = a.a,
      d;
    if (b) {
      if (((d = b), d !== c)) for (c = d; (d = d.a); ) if (d.Y || 3 > !d[0] + !d[1] + !d[2] + !d[3]) c = d;
    } else
  ...
  F.prototype.pa = function (a) {
    var b = this === a,
      c,
      d;
    if (!b && (b = B(a, F))) for (c = this.na, a = a.na, b = (d = c.length) === a.length; b && d--; ) b = c[d] == a[d];
    return b;
  };
        ...
        if (((m = l[g]), (k = m.length))) {
          ...
          for (c = 0; c < k; c += 2)
            (h = m[c]),
              ...
              d.push(h, n),
              (q = m[c - 1]),
              c && ac(n, q) && (e.push(d), (d = []), (q += 0 > q ? 360 : -360), d.push(m[c - 2], q, h, n));
          e.push(d);
        }
      l = e;
    }
  ...
  Pf.prototype.S = function () {
    ...
    if (!(a = this.a)) {
      ...
      var b, c;
      if (this.ma.length)
        for (a = this.ma[0].S(), c = 1; c < this.ma.length; c++) if ((b = this.ma[c].S())) a = a ? a.wb(b) : b;
    }
    return (this.a = a);
  };
  ...
  function Vf(a, b, c, d) {
    ...
    if ((e = Xf(a, b.$a, c, d, b.S()))) {
      ...
      g = b.lb;
      if ((h = g.length))
        for (f.a = f.Ra.length; k < h; k++) if ((e = Xf(a, g[k], c, d, b.ig(k)))) f.Ra = f.Ra.concat(e);
      h = f.Ra.length;
      for (k = 0; k < h; k++)
        if (f.Ra[k] !== Tf) {
          l = !1;
    ...
    if (b.g()) {
      ...
      -1 !== d &&
        ...
        180 !== rb(g) &&
          ...
          k &&
            m &&
            ((l /= rb(k) / rb(m)), (g = h + (h > g ? -l : l)), (f = 0 < f ? 180 : -180), e.splice(d, 0, g, f, g, -f))));
      d = e;
    }
  ...
  Uf.prototype.Tb = function () {
    var a = this.Ca(),
      ...
      d;
    jb(Uf.prototype.Tb);
    if (this.m) for (b = a.ma, d = b.length, a = [], c = 0; c < d; c++) a = a.concat(Yf(b[c].$a, b[c].S()));
    else a = Yf(a.$a, a.S());
    return a;
  };
  ...
  function ug(a) {
    ...
    if (b !== Eg) {
      ...
      c = yg(a);
      if ('EMPTY' === c)
        a.next(), (d = b[1]) ? (f = new d([])) : b !== Gg && ((f = new F([])), b === Fg && (f = new E(f)));
      else if ('(' === c) {
        f = b[0];
        b = b[1];
        var g, h;
  ...
  function nh(a, b) {
    ...
    this.tileSize = a.tileSize;
    this.N = {};
    mh.call(this, { min: a.min, max: a.max, minWorldSize: this.tileSize, projection: c.bj, dark: c.dark });
  }
  v(nh, mh);
  ...
  function rh(a, b, c, d, e) {
    ...
    var l = b.bottom,
      ...
      n,
      q;
    e && ((n = g + (1 + k - g) / 2 + e.x / a.tileSize - 0.5), (q = h + (1 + l - h) / 2 + e.y / a.tileSize - 0.5));
    for (; g < c; ) {
  ...
  Ca(Lh.prototype, {
    ...
    se: function (a) {
      ...
      if ((d = this.Zg[a]))
        (b = this.Hf),
          (c = b[0]),
          c || ((c = b[0] = new Ch()), this.Eb(za(Ac, c)), Wa(this.Ed) || c.importScripts(w.Object.keys(this.Ed))),
          (b = c),
  ...
  $h.prototype.b = function (a) {
    ...
    'load' === b
      ...
      : (c = 4 === a.readyState && 0 === a.status && 'error' == b ? 'cors' : 'error' != b ? b : 'network');
    b = this.b;
    ei(this, 'timeout', b);
    ei(this, 'error', b);
    ei(this, 'load', b);
  ...
  var wi = le,
    le = function (a, b) {
      ...
      if (!d || ('pointerenter' !== (e = b.type) && 'pointerleave' !== e))
        (b.eventPhase = c), (f = wi(a, b)), d && a.src && a.src.jb && null === a.src.jb() && delete b.eventPhase;
      return f;
    };
  function xi(a, b) {
  ...
  function Wi(a, b) {
    ...
    b
      ? (a.bifocal && b.bifocal
          ? ((c = Xi(a)), (d = Xi(b)))
          : b.bifocal
            ? ((c = Yi(a)), (e = Yi(b).distance(c)), (f = Yi(b, !0).distance(c)), (d = e > f ? Yi(b, !0) : Yi(b)))
            : a.bifocal && !b.bifocal
              ? ((d = Yi(b)), (e = Yi(a).distance(d)), (f = Yi(a, !0).distance(d)), (c = e > f ? Yi(a, !0) : Yi(a)))
              : ((c = a), (d = b)),
        (e = c.x - d.x),
        (c = c.y - d.y),
        (c = new Ti(e, c)))
  ...
  pj.prototype.ca = function (a, b, c, d, e, f) {
    ...
    c = d = (d * u) / (ub(2, k) * d);
    this.g ||
      (d % 1 && ((d = pb(d)), (u = c / d), (y = y / u), (J = J / u), (u = ub(2, k) * d)), (y = pb(y)), (J = pb(J)));
    this.o = c;
    k = -d;
    g = n + d;
    for (h = 0; h < f; h++) {
  ...
  p.clear = function (a) {
    var b, c;
    this.c &&
      (a ? this.b.clearRect((b = a.left), (c = a.top), a.right - b, a.bottom - c) : (this.a.width = this.size.w));
  };
  p.D = function () {
  ...
  O.prototype.jh = function (a, b, c, d, e, f, g) {
    var h = Array.prototype.slice.call(arguments, 6),
      ...
      T;
    for (y = 0; y < m; y++)
      f === n.Yf ? ((T = y % k), (J = Math.floor(y / k))) : f === n.Qf && ((T = Math.floor(y / l)), (J = y % l)),
        (q = h[T].Fa[J]),
        (t = h[T].Yc),
        q &&
  ...
  function kk(a, b, c, d) {
    var e = a.za,
      f = a.g.center;
    c === +c && d === +d
      ? ((c = (c - f.x) * e), (d = (d - f.y) * e), a.K.set(c, d), jk(a, c, d), a.a.Ja(b), jk(a, -c, -d))
  ...
  O.prototype.P = function (a, b) {
    ...
    a.ed() ||
      ...
      a.g() && (f.x -= c),
      b
        ? ((h = e.geoToPixel(d)), (k = 2 * mb(h.x - f.x, g.x - h.x)), (h = 2 * mb(h.y - f.y, g.y - h.y)))
  ...
  O.prototype.C = function (a, b, c, d, e) {
    ...
    this.f.mb() &&
      (this.f.gh(a, b, c, d, e),
      this.f.Fd(Aj.COORD) && ((e = this.f), (e = Wi(e.a, e.c)), 0 < Ui(e) && (Ck(this, -e.x, -e.y), (f = !0))),
      this.f.Fd(Aj.ZOOM) &&
        a === +a &&
        b === +b &&
        c === +c &&
  ...
  Kk.prototype.o = function (a, b) {
    var c, d;
    b !== Me.NONE &&
      ((d = this.C[Pe.ANY]), (c = d.a + 1), d.c(c, b), (d = this.C[a.type]), d.c(c, b), a.j().c(c, b), Rg(this, a));
  };
  ...
  L.prototype.a = function (a) {
    ...
    if (a)
      if (a.l !== this) {
        ...
        (B(a, xi) ? this.j : B(a, fh) ? this.B : B(a, Lk) ? this.A : this.v).remove(b), delete b.Lf, delete a.Ua;
  };
      ...
      for (g = []; k--; )
        for (u = a[k], q = u.length, t = 0, l = 1; l < q; l++) {
          if ((y = Vk(u[l - 1], u[l], c, b, d, e)))
            (m = y[0]), (n = y[1]), t && t.pa(m) ? h.push(n) : g.push((h = y)), (t = n), f && ((l = q), (k = 0));
        }
    else g = a;
    return g;
  }
    ...
    if (u)
      for (; q < e; )
        (t = a[q++]),
          ...
          (t = t.y),
          (y = ((f - k) * (m - k) + (t - l) * (n - l)) / u),
          (f = 0 > y ? Wk(f, t, k, l) : 1 < y ? Wk(f, t, m, n) : Wk(f, t, k + y * (m - k), l + y * (n - l))),
          f > g && ((g = f), (h = q - 1));
    else for (; q < e; ) (t = a[q++]), (f = t.x), (t = t.y), (f = Wk(f, t, k, l)), f > g && ((g = f), (h = q - 1));
    g >= b || (0 < c && h - d)
      ? (--c,
  ...
  function $k(a) {
    ...
    if (!(e || b.j(d) || b.g(d))) {
      e = a.a;
      f = a.g;
      if (b.f(d)) for (g = e.length; g--; ) (h = e[g]), h.j().f(d) && (e.splice(g, 1), (k = k || al(a, h.ta())));
      if (b.i(d)) {
        for (g = e.length; g--; )
  ...
  Yk.prototype.T = function (a, b, c, d) {
    ...
    if (b === If) e && (gl(d, c), d.fillRect(0, 0, k, k));
      ...
      (f && el(d, c, this.Wb), c.a && (g = a.s) && ((h = c.lineWidth), g.fd || (g = null)), (a = b.b), a === Lb)
    ) {
        ...
        for (f = k.length; f--; ) {
          ...
          if (!(u = m && l === If) && (u = m || q)) {
            ...
            for (
              ...
              if (((Jb = l[rf]), (ia = rf >= la), (na = !ia && rf >= ea), Jb === Tf && J)) na ? mk++ : nk++;
              else {
                lk = Jb.length;
                il.length = 2 * lk;
  ...
  jl.prototype.o = function (a, b, c, d) {
    ...
    if ((f = this.f.get(e, d)) && (d || $k(f)))
      return (a = this.b.pop() || document.createElement('canvas')), f.ca(a) || this.b.push(a), this.c.add(e, f, 1), f;
  ...
  Jj.prototype.c = function (a, b, c) {
    var d = this.j,
      e;
    return d.providesMarkers() && (e = d.requestMarkers(a, b, !0, c)).length ? { markers: e, total: e.length } : kl;
  };
  ...
  Jj.prototype.g = function (a, b, c, d) {
    ...
    this.j.providesSpatials()
      ? ((e = this.i.g(a, b, c, d)),
        c || ((c = this.f), (e = tj()), 33 < e - c.j && (Qk(c.v), (c.j = e)), (e = this.i.g(a, b, !0, d))))
      : (e = ll);
    return e;
  };
