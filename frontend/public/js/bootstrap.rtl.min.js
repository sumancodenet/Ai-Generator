...
!(function (t, e) {
    ...
    lt = (function () {
      ...
      return (
        ...
        (t._slide = function (t, e) {
          ...
          if ((t === M ? ((n = G), (i = z), (o = q)) : ((n = X), (i = J), (o = K)), l && g(l).hasClass(V)))
            this._isSliding = !1;
              ...
              if (0 < i)
                for (var o = 0; o < i; o++) {
                  var r = this._triggerArray[o],
                    s = _.getSelectorFromElement(r);
                  if (null !== s)
                    g([].slice.call(document.querySelectorAll(s))).hasClass(pt) ||
    ...
    Gt = (function () {
      ...
      return (
          ...
          if (!(this._element.disabled || g(this._element).hasClass(Ht) || g(this._menu).hasClass(jt))) {
            ...
            g(n).trigger(e),
              e.isDefaultPrevented() ||
                (g(this._menu).toggleClass(jt), g(n).toggleClass(jt).trigger(g.Event(Lt.SHOWN, t)));
          }
        }),
        (t.hide = function () {
          if (!this._element.disabled && !g(this._element).hasClass(Ht) && g(this._menu).hasClass(jt)) {
            ...
            g(n).trigger(e),
              e.isDefaultPrevented() ||
                (g(this._menu).toggleClass(jt), g(n).toggleClass(jt).trigger(g.Event(Lt.HIDDEN, t)));
          }
        }),
        (t.dispose = function () {
        ...
        (t._getPlacement = function () {
          ...
          return (
            t.hasClass(Rt)
              ? ((e = Vt.TOP), g(this._menu).hasClass(Wt) && (e = Vt.TOPEND))
              : t.hasClass(Ut)
                ? (e = Vt.RIGHT)
                : t.hasClass(Ft)
                  ? (e = Vt.LEFT)
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), g(this).data(wt, t)), 'string' == typeof e)
            ) {
        ...
        (c._dataApiKeydownHandler = function (t) {
          if (
            (/input|textarea/i.test(t.target.tagName)
              ? !(
                  32 === t.which ||
                  (27 !== t.which && ((40 !== t.which && 38 !== t.which) || g(t.target).closest(Kt).length))
                )
              : kt.test(t.which)) &&
  ...
  var _e = 'tooltip',
    ...
    Se =
      (((zt = { AUTO: 'auto', TOP: 'top' })[Te ? 'LEFT' : 'RIGHT'] = 'right'),
      (zt.BOTTOM = 'bottom'),
      ...
      return (
        ...
        (t._enter = function (t, e) {
          ...
          (e = e || g(t.currentTarget).data(n)) ||
            ...
            g(e.getTipElement()).hasClass(Ne) || e._hoverState === Ie
              ? (e._hoverState = Ie)
        ...
        (t._fixTransition = function () {
          ...
          null === t.getAttribute('x-placement') &&
            (g(t).removeClass(Ae), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new i(this, e)), g(this).data(me, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), g(this).data(Fe, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
      ...
      return (
        ...
        (t._activate = function (e) {
          ...
          n.hasClass(rn)
            ...
            g(this._scrollElement).trigger(on.ACTIVATE, { relatedTarget: e });
        }),
        (t._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  var jn = 'toast',
    ...
    Yn = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            (t = l({}, Bn, g(this._element).data(), 'object' == typeof t && t ? t : {})),
